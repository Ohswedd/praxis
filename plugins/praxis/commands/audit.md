...
performance, completeness — plus accessibility and design-consistency when the
change touches UI surface) and the horizontal consistency pass. Fix every FAIL,
